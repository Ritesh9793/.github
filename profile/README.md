...
---
## Introduction
Backend-focused Developer with hands-on experience building scalable Spring Boot microservices, REST APIs, 
...
- Frontend: ReactJS, TailwindCSS, ShadCN, 24Dev, MaterialUI, etc.
- Database: MySQL, MongoDB, PostreSQL, Supabase, Redis, Valkey
- Core CS: OOPs, DSA, Computer Network, SDLC, SPM, SE, VMs, OS(Windows & Linux)
